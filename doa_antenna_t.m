...
Ite_num = 2e2;%number of iterations 2e2
...
% Ms = [25;49;64;100];
Ms = [25;49;64;100;144;];
bound_store = zeros(M_n, 4);
rmse_store_theta = zeros(M_n, 3);
rmse_store_phi = zeros(M_n, 3);
rmse_store_theta_d = zeros(M_n, 3);
rmse_store_phi_d = zeros(M_n, 3);
...
axes('FontSize',16);
subplot(2,2,1)
semilogy(Ms,rmse_store_theta(1:M_n,1),'b-.o','LineWidth',1,'MarkerSize',6)
hold on
semilogy(Ms,rmse_store_theta(1:M_n,2),'m-.x','LineWidth',1,'MarkerSize',6)
semilogy(Ms,rmse_store_theta(1:M_n,3),'k-.*','LineWidth',1,'MarkerSize',6)
semilogy(Ms,bound_store(1:M_n,1),'rs-','LineWidth',1,'MarkerSize',6)
grid on
le = legend('DISPARE [37]','Subspace [40]','Proposed','CRB (72)', 'Location','Northeast');
set(le,'Fontsize',8,'Fontname','Times')
set(gca,'XTick',Ms)
xlim([min(Ms), max(Ms)])
xlabel({'Number of the BS antennas M','(a)'},'Fontsize',10,'Fontname','Times')
ylabel('RMSE of \theta estimate  (degrees)','Fontsize',10,'Fontname','Times')
%%%%%%%%%%%
subplot(2,2,2)
semilogy(Ms,rmse_store_phi(1:M_n,1),'b-.o','LineWidth',1,'MarkerSize',6)
hold on
semilogy(Ms,rmse_store_phi(1:M_n,2),'m-.x','LineWidth',1,'MarkerSize',6)
semilogy(Ms,rmse_store_phi(1:M_n,3),'k-.*','LineWidth',1,'MarkerSize',6)
semilogy(Ms,bound_store(1:M_n,2),'rs-','LineWidth',1,'MarkerSize',6)
grid on
le = legend('DISPARE [37]','Subspace [40]','Proposed','CRB (72)', 'Location','Northeast');
set(le,'Fontsize',8,'Fontname','Times')
set(gca,'XTick',Ms)
xlim([min(Ms), max(Ms)])
xlabel({'Number of the BS antennas M','(b)'},'Fontsize',10,'Fontname','Times')
ylabel('RMSE of \phi estimate (degrees)','Fontsize',10,'Fontname','Times')
%%%%%%%%%%%
subplot(2,2,3)
semilogy(Ms,rmse_store_theta_d(1:M_n,1),'b-.o','LineWidth',1,'MarkerSize',6)
hold on
semilogy(Ms,rmse_store_theta_d(1:M_n,2),'m-.x','LineWidth',1,'MarkerSize',6)
semilogy(Ms,rmse_store_theta_d(1:M_n,3),'k-.*','LineWidth',1,'MarkerSize',6)
semilogy(Ms,bound_store(1:M_n,3),'rs-','LineWidth',1,'MarkerSize',6)
grid on
le = legend('DISPARE [37]','Subspace [40]','Proposed','CRB (72)', 'Location','Northeast');
set(le,'Fontsize',8,'Fontname','Times')
set(gca,'XTick',Ms)
xlim([min(Ms), max(Ms)])
xlabel({'Number of the BS antennas M','(c)'},'Fontsize',10,'Fontname','Times')
ylabel('RMSE of \sigma_{\theta} estimate (degrees)','Fontsize',10,'Fontname','Times')
%%%%%%%%%%%
subplot(2,2,4)
semilogy(Ms,rmse_store_phi_d(1:M_n,1),'b-.o','LineWidth',1,'MarkerSize',6)
hold on
semilogy(Ms,rmse_store_phi_d(1:M_n,2),'m-.x','LineWidth',1,'MarkerSize',6)
semilogy(Ms,rmse_store_phi_d(1:M_n,3),'k-.*','LineWidth',1,'MarkerSize',6)
semilogy(Ms,bound_store(1:M_n,4),'rs-','LineWidth',1,'MarkerSize',6)
grid on
le = legend('DISPARE [37]','Subspace [40]','Proposed','CRB (72)', 'Location','Northeast');
set(le,'Fontsize',8,'Fontname','Times')
set(gca,'XTick',Ms)
xlim([min(Ms), max(Ms)])
xlabel({'Number of the BS antennas M','(d)'},'Fontsize',10,'Fontname','Times')
